package com.bmsoft.common.handler;
...
public abstract class DefaultGlobalExceptionHandler {
    ...
    public R<String> jwtExpiredException(ExpiredJwtException ex, HttpServletRequest request) {
        log.warn("ExpiredJwtException:", ex);
        return R.result(ExceptionCode.JWT_TOKEN_EXPIRED, EMPTY).setPath(request.getRequestURI());
    }
	
	@ExceptionHandler(UnsupportedJwtException.class)
    public R<String> jwtUnsupportedException(UnsupportedJwtException ex, HttpServletRequest request) {
        log.warn("UnsupportedJwtException:", ex);
        return R.result(ExceptionCode.JWT_PARSER_TOKEN_FAIL, EMPTY).setPath(request.getRequestURI());
    }
	
	@ExceptionHandler(MalformedJwtException.class)
    public R<String> jwtMalformedException(MalformedJwtException ex, HttpServletRequest request) {
        log.warn("MalformedJwtException:", ex);
        return R.result(ExceptionCode.JWT_PARSER_TOKEN_FAIL, EMPTY).setPath(request.getRequestURI());
    }
	
	@ExceptionHandler(SignatureException.class)
    public R<String> jwtSignatureException(SignatureException ex, HttpServletRequest request) {
        log.warn("SignatureException:", ex);
        return R.result(ExceptionCode.JWT_SIGNATURE, EMPTY).setPath(request.getRequestURI());
    }
    ...
    public R missingServletRequestPartException(MissingServletRequestPartException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.REQUIRED_FILE_PARAM_EX.getCode(), EMPTY, ExceptionCode.REQUIRED_FILE_PARAM_EX.getMsg()).setPath(request.getRequestURI());
    }
    ...
    public R servletException(ServletException ex, HttpServletRequest request) {
        ...
        if (msg.equalsIgnoreCase(ex.getMessage())) {
            return R.result(ExceptionCode.REQUIRED_FILE_PARAM_EX.getCode(), EMPTY, ExceptionCode.REQUIRED_FILE_PARAM_EX.getMsg());
        }
    ...
    public R<String> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        ...
        return R.result(ExceptionCode.METHOD_NOT_ALLOWED.getCode(), EMPTY, ExceptionCode.METHOD_NOT_ALLOWED.getMsg()).setPath(request.getRequestURI());
    }
